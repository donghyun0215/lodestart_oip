...
export const STRINGS = {
  en: {
    ...
    hero_sub:
      "K-Innovation Partners runs the proof-of-concept and open innovation layer between Korea's proven companies and Singapore's institutions. Every company on this platform is curated, verified, and introduced by us.",
    ...
    // swimmy intro
    sw_kicker: "Who we are",
    sw_line_a: "Small fish, together,",
    sw_line_b: "become the big fish.",
    sw_body:
      "Our name comes from Leo Lionni's Swimmy — the small fish who taught his school to swim as one giant fish. K-Innovation Partners is the collective voice for Korean founders and the startup ecosystem in Singapore, backed by the Korean Embassy, KOCHAM, and Korean agencies including KSC, NIPA, KOCCA, and KTO. We bring Korea's boldest innovators into Singapore — through PoC and pilot tests, open innovation, AI outreach, and demo days.",
    ...
    theme_sub:
      "Companies from K-Innovation Partners's FINNECT accelerator cohort, grouped by what they actually build. More themes join as new cohorts come through.",
    ...
    // footer
    ft_blurb:
      "K-Innovation Partners connects Korea's proven companies with Singapore's institutions — through curated proof-of-concept engagements and open innovation.",
    ft_navigate: "Navigate",
    ft_contact: "Contact",
    ft_follow: "Follow",
    ft_community: "Community",
    ft_rights: "© 2026 All rights reserved by K-Innovation Partners co., Ltd",
  },
  ...
  ko: {
    ...
    hero_sub:
      "K-Innovation Partners는 한국의 검증된 기업과 싱가포르 기관 사이에서 PoC와 오픈 이노베이션을 연결합니다. 본 플랫폼의 모든 기업은 저희가 직접 선별하고 검증하여 소개합니다.",
    ...
    theme_sub:
      "K-Innovation Partners의 FINNECT 액셀러레이터 기수를 거친 기업들을 실제로 만드는 것 기준으로 묶었습니다. 새 기수가 들어올 때마다 테마도 늘어납니다.",
    theme_view: "기업 보기",
    ...
    ft_blurb:
      "K-Innovation Partners는 선별된 PoC와 오픈 이노베이션을 통해 한국의 검증된 기업과 싱가포르 기관을 연결합니다.",
    ft_navigate: "메뉴",
    ft_contact: "연락처",
    ft_follow: "팔로우",
    ft_community: "커뮤니티",
    ft_rights: "© 2026 K-Innovation Partners co., Ltd. All rights reserved.",
  },
};
