...
export const STRINGS = {
  en: {
    ...
    ins_sub: "Incorporation, first PoCs, hiring, and what actually happens on the ground — field notes from our team on LinkedIn.",
    ins_read: "Read on LinkedIn",
  ...
  ko: {
    ...
    ins_title_b: "실전 노트",
    ins_sub: "법인 설립, 첫 PoC, 채용, 그리고 현장에서 실제로 벌어지는 일들 — 저희 팀의 링크드인 필드 노트입니다.",
    ins_read: "링크드인에서 읽기",
