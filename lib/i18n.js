...
export const STRINGS = {
  ...
  ko: {
    ...
    sw_kicker: "우리는",
    sw_line_a: "작은 물고기들이 모여,",
    sw_line_b: "큰 물고기가 됩니다.",
    sw_body:
      "K-Innovation Partners라는 이름은 레오 리오니의 동화 「스위미(Swimmy)」에서 왔습니다. 작은 물고기들이 하나의 큰 물고기처럼 헤엄쳐 바다를 헤쳐 나가듯, 저희는 싱가포르 내 한국 창업자와 스타트업 생태계의 집합적 목소리입니다. 주싱가포르 대한민국 대사관, KOCHAM, 그리고 KSC·NIPA·KOCCA·KTO와 함께 PoC와 파일럿, 오픈 이노베이션, AI 아웃리치, 데모데이를 통해 한국의 혁신 기업을 글로벌 무대로 연결합니다.",
